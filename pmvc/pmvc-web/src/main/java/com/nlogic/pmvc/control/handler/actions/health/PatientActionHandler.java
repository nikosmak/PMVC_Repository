...
public class PatientActionHandler extends ActionHandler {
	...
	public String action() {
		...
		String linkFourLabel = resourceLoader.getResourceValue(HealthUserIntefaceKeys.LINK_FOUR_LABEL_PATIENT_KEY, Resources.HEALTH_UI);
		String linkFourURL = resourceLoader.getResourceValue(HealthUserIntefaceKeys.LINK_FOUR_URL_PATIENT_KEY, Resources.HEALTH_UI);
		
		String linkFiveLabel = resourceLoader.getResourceValue(HealthUserIntefaceKeys.LINK_FIVE_LABEL_PATIENT_KEY, Resources.HEALTH_UI);
		String linkFiveURL = resourceLoader.getResourceValue(HealthUserIntefaceKeys.LINK_FIVE_URL_PATIENT_KEY, Resources.HEALTH_UI);
